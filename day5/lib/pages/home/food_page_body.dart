...
import 'package:day5/widgets/icon_and_text_widget.dart';
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              BigText(text: "Nutritious fruit meal in NTN"),
                              SizedBox(
                                height: Dimensions.height10,
                              ),
                              SmallText(text: "With NTN characteristics"),
                              Row(
                                mainAxisAlignment:
                                ...
                                children: [
                                  IconAndTextWidget(
                                      ...
                                      text: "Normal",
                                      iconClor: AppColors.iconColor1),
                                  IconAndTextWidget(
                                      icon: Icons.location_on,
                                      text: "1.7km",
                                      iconClor: AppColors.mainColor),
                                  IconAndTextWidget(
                                      icon: Icons.access_time_rounded,
                                      text: "32min",
                                      iconClor: AppColors.iconColor2),
                                ],
                              )
                            ],
                          ),
